...
if($argv[1]=='--sync'){SyncSafeBoxes();exit();}
if($argv[1]=='--init'){SafeBoxUSer($argv[2]);exit();}
if($argv[1]=='--umount'){SafeBoxUmount($argv[2]);exit();}
if($argv[1]=='--open'){crypt_open($argv[2]);exit();}
if($argv[1]=='--fsck'){fsck($argv[2]);exit();}
