...
if(isset($_POST["artica_ip_addr"])){BuildList();exit();}
...
function ImportNets(){
	...
	if(!is_array($ini->_params)){writelogs("No artica masters defined",__FUNCTION__,__FILE__,__LINE__);exit();}
	if(count($ini->_params)==0){writelogs("No artica masters defined",__FUNCTION__,__FILE__,__LINE__);exit();}
