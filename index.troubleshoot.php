...
function troubleshootPage(){
   YahooWin2('750','$page?start=yes','$title');                
}
...
function slapindex(){
	...
	$table="<table style='width:99%' class=form>";
...
$html="<div style='font-size:16px;font-weight:bold'>{index_ldap_databases}</div>
	$table";
...
$table="<div style='width:95%;height:350px;overflow:auto' class=form>$table</table></div>";
		
	
$html="<div style='font-size:16px;font-weight:bold;margin-bottom:10px'>{restore_ldap_database}</div>
	$table";	
...
$tbl=explode("\n",$datas);
	...
	foreach ($tbl as $num=>$ligne){
		...
		$table="<div style='width:95%;height:400px;overflow:auto' class=form>$table</table></div>";
		
		
	
$html="<div style='font-size:16px;font-weight:bold;margin-bottom:10px'>{restore_ldap_database} $file</div>
	$table";
