...
if($argv[1]=='--comps'){computers();exit();}
if($argv[1]=='--resolv'){resolv_computers();exit();}
if($argv[1]=='--backup-server'){set_backup_server();exit();}
...
function buildmain(){
	$sock=new sockets();
	$config=unserialize(base64_decode($GLOBALS["CLASS_SOCKETS"]->GET_INFO("AmandaServerConfig")));
