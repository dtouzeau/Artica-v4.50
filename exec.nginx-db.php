...
$GLOBALS["WORKDIR"]="/home/nginxdb";
$GLOBALS["SERV_NAME"]="nginx-db";
$GLOBALS["MYSQL_PID"]="/var/run/nginxdb.pid";
$GLOBALS["MYSQL_SOCKET"]="/var/run/nginxdb.sock";
...
function initd(){
	...
	$f[]="# Short-Description: Artica Nginx statistics database";
	$f[]="# chkconfig: 2345 11 89";
	$f[]="# description:Artica Nginx statistics database";
	$f[]="### END INIT INFO";
	$f[]="case \"\$1\" in";
	$f[]=" start)";
