...
$GLOBALS["CACHEFILE"]=PROGRESS_DIR."/squid.logsfinder.progress";
$GLOBALS["LOGSFILES"]=PROGRESS_DIR."/squid.logsfinder.progress.log";
...
function title(){
	...
	$tpl=new templates();
	$title=$tpl->_ENGINE_parse_body("{searching}....");
	return $title;
}
...
function Launch(){
	$sock=new sockets();
	$cmd="squid2.php?logsfinder={$_GET["id"]}";
