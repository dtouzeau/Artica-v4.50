...
if(!$users->AsAnAdministratorGeneric){die("DIE " .__FILE__." Line: ".__LINE__);}
...
$sql="SELECT mount_md5 FROM dar_index GROUP BY mount_md5";
	...
	$resultats=$q->QUERY_SQL($sql,'artica_backup');
		while($ligne=@mysqli_fetch_array($resultats,MYSQLI_ASSOC)){
...
<td colspan=2 align='right'>
	<input type='button' value='{restore}&nbsp;&raquo;&raquo;' OnClick=\"Loadjs('dar.restore.php?fileid=$id')\">
</td>
</tr>
