...
function popup(){
	...
	<p style='font-size:18px;margin-bottom:20px' class=text-info>{didyouknow_unbound}</p>
		
	<center style='margin:20px'>
		<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/6PyyJpXKjCs\" frameborder=\"0\" allowfullscreen></iframe>
	</center>
...
function HIDE(){
	$sock=new sockets();
	$sock->SET_INFO("DidYouKnowUnbound", 1);
