...
function js(){
	...
	$title=$tpl->javascript_parse_text("{APP_IPAUDIT} {enable_feature}");
...
function popup(){
	...
	$sock->getFrameWork("ipaudit.php?install=yes");
	$t=$_GET["t"];
	if(!is_numeric($t)){$t=time();}
	$text=$tpl->_ENGINE_parse_body("{APP_IPAUDIT} {enable_feature}...");
