...
$GLOBALS["PROGRESS_FILE"]="/usr/share/artica-postfix/ressources/logs/postgres.backup.progress";
$GLOBALS["LOG_FILE"]=PROGRESS_DIR."/postgres.backup.progress.txt";
...
function js(){
	...
	$title=$tpl->javascript_parse_text("{backup_database}");
...
function popup(){
	...
	$sock->getFrameWork("postgres.php?backup=yes");
	$t=$_GET["t"];
	if(!is_numeric($t)){$t=time();}
	$text=$tpl->_ENGINE_parse_body("{backup_database}...");
