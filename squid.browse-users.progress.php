<?php
$GLOBALS["CACHEFILE"]=PROGRESS_DIR."/squid.browse-users.progress.php.log";
$GLOBALS["LOGSFILES"]=PROGRESS_DIR."/squid.browse-users.progress.php.log.log";
...
function Launch(){
	$sock=new sockets();
	$cmd="squid.php?report-centers-users-cache=yes".suffix();
