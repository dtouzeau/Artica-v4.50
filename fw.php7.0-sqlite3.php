...
function js(){
	...
	$tpl=new template_admin();
	$tpl->js_dialog6("{system}::php7.0-sqlite3", "$page?popup=yes",650);
}
...
function popup(){
	...
	$ARRAY["CMD"]="services.php?apt-get-install=php7.0-sqlite3";
	$ARRAY["TITLE"]="{system} {installing} php7.0-sqlite3";
