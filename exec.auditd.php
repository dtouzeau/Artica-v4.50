...
if($argv[1]=='--import'){build();import();exit();}
if($argv[1]=='--conf'){conf();exit();}
...
function import(){
	...
	$unix=new unix();
	if($unix->process_exists(@file_get_contents($pidfile))){exit();}
