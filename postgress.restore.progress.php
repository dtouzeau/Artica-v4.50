...
$GLOBALS["PROGRESS_FILE"]="/usr/share/artica-postfix/ressources/logs/postgres.restore.progress";
$GLOBALS["LOG_FILE"]=PROGRESS_DIR."/postgres.restore.progress.txt";
...
function js(){
	...
	$title=$tpl->javascript_parse_text("{restore_database}");
...
function popup(){
	...
	$sock->getFrameWork("postgres.php?restore-progress=yes&filename=$filename");
	$t=$_GET["t"];
	if(!is_numeric($t)){$t=time();}
	$text=$tpl->_ENGINE_parse_body("{restore_database}...");
