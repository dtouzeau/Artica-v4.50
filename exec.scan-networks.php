...
if(!isBuildPid(__FILE__)){compevents("Error execution");exit();}

	$disabled_content=$GLOBALS["CLASS_SOCKETS"]->GET_INFO("NetworkScannerMasksDisabled");
		$exploded=explode("\n",$disabled_content);
