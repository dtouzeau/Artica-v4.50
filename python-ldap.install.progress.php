...
$GLOBALS["LOG_FILE"]=PROGRESS_DIR."/influxdb.install.progress.txt";
...
function js(){
	...
	$title=$tpl->javascript_parse_text("Python LDAP");
...
function popup(){
	...
	$restart=null;
	$addon=null;
	$sock->getFrameWork("postgres.php?python-ldap=yes");
	$t=$_GET["t"];
	if(!is_numeric($t)){$t=time();}
	$text=$tpl->_ENGINE_parse_body("{installing}...");
