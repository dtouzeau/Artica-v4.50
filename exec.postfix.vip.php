...
if($argv[1]=="--report"){report($argv[2]);exit();}
if($argv[1]=="--reports"){$GLOBALS["FORCE"]=true;BuildReports();exit();}
...
if($argv[1]=="--query"){query();exit();}
if($argv[1]=="--query2"){query2();exit();}
if($argv[1]=="--queue"){PostQueue();exit();}
