...
function js(){
	...
	$tpl=new template_admin();
	$tpl->js_dialog6("{system}::libdbd-sqlite3-perl", "$page?popup=yes",650);
}

function popup(){
	$ARRAY["PROGRESS_FILE"]=PROGRESS_DIR."/php7install.progress";
	$ARRAY["LOG_FILE"]=PROGRESS_DIR."/php7install.log";	
	$ARRAY["CMD"]="services.php?apt-get-install=libdbd-sqlite3-perl";
	$ARRAY["TITLE"]="{system} {installing} libdbd-sqlite3-perl";
