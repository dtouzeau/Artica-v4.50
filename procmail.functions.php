...
$usr=new usersMenus();
	...
	$subtitle="<div style='font-size:12px;border-bottom:1px solid #005447;width:100%;font-weight:bolder;color:#005447;margin-bottom:5px;'><strong>{$hash["name"]}</strong></div>";
	}
