<?php
$GLOBALS["CACHEFILE"]=PROGRESS_DIR."/squid.reload.progress";
$GLOBALS["LOGSFILES"]=PROGRESS_DIR."/squid.reload.progress.log";
...
function title(){
	...
	$tpl=new templates();
	$title=$tpl->_ENGINE_parse_body("{APP_SQUID}::{reloading_service}");
	return $title;
}
