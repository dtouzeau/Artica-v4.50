...
$GLOBALS["CACHEFILE"]=PROGRESS_DIR."/squid.google.progress";
$GLOBALS["LOGSFILES"]=PROGRESS_DIR."/squid.google.progress.txt";
...
function title(){
	...
	$tpl=new templates();
	$title=$tpl->_ENGINE_parse_body("{APP_SQUID}::{disable_google_ssl}");
	return $title;
}
...
function Launch(){
	...
	$cmd="squid.php?google-no-ssl-progress=yes";
