...
$GLOBALS["CACHEFILE"]=PROGRESS_DIR."/ufdbguard.disable.progress";
$GLOBALS["LOGSFILES"]=PROGRESS_DIR."/ufdbguard.disable.progress.log";
...
function title(){
	...
	$tpl=new templates();
	$title=$tpl->_ENGINE_parse_body("{disable_service}");
	return $title;
}
...
function Launch(){
	$sock=new sockets();
	$cmd="ufdbguard.php?uninstall-progress=yes";
