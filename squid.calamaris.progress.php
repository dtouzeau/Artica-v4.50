...
$GLOBALS["PROGRESS_FILE"]="/usr/share/artica-postfix/ressources/logs/calamaris.run.progress";
$GLOBALS["LOG_FILE"]=PROGRESS_DIR."/calamaris.run.progress.txt";
...
function js(){
	...
	$title=$tpl->javascript_parse_text("{calamaris_statistics} {run}");
...
function popup(){
	...
	$sock->getFrameWork("squid2.php?run-calamaris=yes");
	$t=$_GET["t"];
