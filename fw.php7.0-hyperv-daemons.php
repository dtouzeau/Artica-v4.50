...
function js(){
	...
	$tpl=new template_admin();
	$tpl->js_dialog6("{system}::hyperv-daemons", "$page?popup=yes",650);
}
...
function popup(){
	...
	$ARRAY["CMD"]="services.php?apt-get-install=hyperv-daemons";
	$ARRAY["TITLE"]="{system} {installing} hyperv-daemons";
