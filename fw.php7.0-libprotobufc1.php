...
function js(){
	...
	$tpl=new template_admin();
	$tpl->js_dialog6("{system}::libprotobuf-c1", "$page?popup=yes",650);
}
...
function popup(){
	...
	$ARRAY["CMD"]="services.php?apt-get-install=libprotobuf-c1";
	$ARRAY["TITLE"]="{system} {installing} libprotobuf-c1";
