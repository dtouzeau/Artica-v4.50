...
include_once(dirname(__FILE__)."/ressources/class.users.menus.inc");
	...
	if(system_is_overloaded(basename(__FILE__))){
		writelogs("{OVERLOADED_SYSTEM} {$GLOBALS["SYSTEM_INTERNAL_LOAD"]}, aborting task",__FILE__,__FUNCTION__,__FILE__,__LINE__);
		exit();
	}
	
$users=new usersMenus();
if($users->SQUID_APPLIANCE){events("SQUID_APPLIANCE -> DIE");exit();}
if($users->STATS_APPLIANCE){events("WEBSTATS_APPLIANCE -> DIE");exit();}
