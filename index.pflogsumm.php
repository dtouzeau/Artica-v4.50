...
<table style='width:99%' class=form>
			...
			<tr>
				<td colspan=2 align='right'><input type='button' OnClick=\"Loadjs('artica.settings.php?ajax-notif=yes');\" value='{parameters}&nbsp;&raquo;'></td>
			</tr>
			</table>";	
...
function pflogsumm_popup(){
	...
	if($pflogsumm->notif_enabled==0){
		...
		<input type='button' OnClick=\"Loadjs('artica.settings.php?ajax-notif=yes');\" value='{parameters}&nbsp;&raquo;'>
		</div>
