...
$GLOBALS["LOG_FILE"]=PROGRESS_DIR."/upgradev10.progress.txt";
...
function js(){
	...
	$title=$tpl->javascript_parse_text("{perform_upgrade}");
	echo "
	YahooWinBrowseHide();		
...
function popup(){
	...
	$sock->getFrameWork("system.php?upgradev10=yes");
	$t=$_GET["t"];
	if(!is_numeric($t)){$t=time();}
	$text=$tpl->_ENGINE_parse_body("{please_wait_preparing_settings} {perform_upgrade}...");
