...
function FilesLogs(){
	...
	$GLOBALS["LOG_FILE"]=PROGRESS_DIR."/create-user.progress.txt";
...
function popup(){
	...
	$filename=$_GET["filename"];
	$filename_enc=urlencode($filename);
	$sock->getFrameWork("system.php?create-user-progress=yes");
	$t=$_GET["t"];
	if(!is_numeric($t)){$t=time();}
	$text=$tpl->_ENGINE_parse_body("{please_wait_creating_member}...");
