...
$GLOBALS["CACHEFILE"]=PROGRESS_DIR."/squid.urgency.hypercache.progress";
$GLOBALS["LOGSFILES"]=PROGRESS_DIR."/squid.urgency.hypercache.progress.txt";
...
function title(){
	...
	$tpl=new templates();
	$title=$tpl->_ENGINE_parse_body("{APP_SQUID}::{hypercache_in_emergency_mode}");
	return $title;
}
...
function Launch(){
	$sock=new sockets();
	$cmd="squid.php?disable-hypercache-urgency=yes";
