...
if($argv[1]=="--dirs"){parsedirs($argv[2]);die("DIE " .__FILE__." Line: ".__LINE__);}
if($argv[1]=="www"){www();die("DIE " .__FILE__." Line: ".__LINE__);}
if($argv[1]=="--countries"){countries();die("DIE " .__FILE__." Line: ".__LINE__);}
if($argv[1]=="--replace"){replacesex();die("DIE " .__FILE__." Line: ".__LINE__);}
...
function importlangs(){
	echo "importlangs()\n";
	$GLOBALS["langs"]=array("fr","en","po","es","it","br","pol","de");
