...
$GLOBALS["PROGRESS_FILE"]="/usr/share/artica-postfix/ressources/logs/zfs.install.progress";
$GLOBALS["LOG_FILE"]="/usr/share/artica-postfix/ressources/logs/web/zfs.install.progress.txt";
...
function js(){
	...
	$title=$tpl->javascript_parse_text("{install_zfs}");
...
function popup(){
	...
	$sock->getFrameWork("zfs.php?install=yes");
	$t=$_GET["t"];
	if(!is_numeric($t)){$t=time();}
	$text=$tpl->_ENGINE_parse_body("{install_zfs}...");
