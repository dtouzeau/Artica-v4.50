...
function config(){
	...
	<tr>
		<td valign='top' nowrap style='width:1%;font-size:13px' align='right'>{EnableAuditd}:</td>
		<td>". Field_checkbox("EnableAuditd",1,$EnableAuditd,"EnableAuditd()")."</td>
	</tr>
	<tr>
		<td valign='top' nowrap style='width:1%;font-size:13px' align='right'>{AuditFrequency}:</td>
	...
	<tr>
		<td valign='top' nowrap style='width:1%;font-size:13px' align='right'>{MaxEventsInDatabase}:</td>
	...
	<tr>
		<td valign='top' nowrap style='width:1%;font-size:13px' align='right'>{mail}:</td>
	...
	<tr>
		<td valign='top' nowrap style='width:1%;font-sjs-folderize:13px' align='right'>{space_left}:</td>
	...
	<tr>
		<td valign='top' nowrap style='width:1%;font-size:13px' align='right'>{space_left_action}:</td>
	...
	<tr>
		<td valign='top' nowrap style='width:1%;font-size:13px' align='right'>{admin_space_left}:</td>
	...
	<tr>
		<td valign='top' nowrap style='width:1%;font-size:13px' align='right'>{disk_full_action}:</td>
	...
	<tr>
		<td valign='top' nowrap style='width:1%;font-size:13px' align='right'>{disk_error_action}:</td>
...
while($ligne=@mysqli_fetch_array($results,MYSQLI_ASSOC)){
		...
		$html=$html."
		<tr class=$classtr>
			<td nowrap style='width:1%;height:auto'>$time</td>
			<td width=99% style='height:auto'><strong>{$ligne["file"]}</td>
			<td nowrap style='width:1%;height:auto'>". imgtootltip("tree_loupe.gif","{filter}:{filename}<hr>$futext<hr>","AuditdByFile('$fu')")."</td>
			<td width=1% align=center style='height:auto'><strong>{{$ligne["syscall"]}}</strong></td>
			<td nowrap style='width:1%;height:auto'>". imgtootltip("tree_loupe.gif","{filter}:{action}<hr>{$ligne["syscall"]}<hr>","AuditdByAction('{$ligne["syscall"]}')")."</td>
