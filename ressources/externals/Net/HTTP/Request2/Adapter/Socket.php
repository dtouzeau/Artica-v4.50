...
require_once '/usr/share/artica-postfix/ressources/externals/Net/HTTP/Request2/Adapter.php';

/** Socket wrapper class */
require_once '/usr/share/artica-postfix/ressources/externals/Net/HTTP/Request2/SocketWrapper.php';
...
class HTTP_Request2_Adapter_Socket extends HTTP_Request2_Adapter
{
    ...
    protected function connect()
    {
        ...
        if ($keepAlive && !empty(self::$sockets[$socketKey])
            ...
            if ($socksProxy) {
                require_once '/usr/share/artica-postfix/ressources/externals/Net/HTTP/Request2/SOCKS5.php';
