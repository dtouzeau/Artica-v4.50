...
if($argv[1]=='--config'){buildconfig();exit();}

if($argv[1]=="--init"){build_init();exit();}

if($argv[1]=="--affect"){buid_affectation();exit();}
...
function buildconfig(){
	$unix=new unix();
	$sock=new sockets();
	$array=unserialize(base64_decode($GLOBALS["CLASS_SOCKETS"]->GET_INFO("BackupPCGeneralConfig")));
