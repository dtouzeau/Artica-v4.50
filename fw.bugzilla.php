...
function table(){
	...
	$html[]="<th data-sortable=true class='text-capitalize' data-type='text' style='width:1%' nowrap>{component}</th>";
	$html[]="<th data-sortable=true class='text-capitalize' data-type='text' style='width:1%' nowrap>{subject}</th>";
	$html[]="<th data-sortable=true class='text-capitalize' data-type='text' style='width:1%' nowrap>{created}</th>";
	$html[]="<th data-sortable=true class='text-capitalize' data-type='text' style='width:1%' nowrap>{updated}</th>";
	$html[]="<th data-sortable=true class='text-capitalize' data-type='text' style='width:1%' nowrap>{reply}</th>";
	...
	foreach ($results as $index=>$ligne){
		...
		$html[]="<td style='width:1%' nowrap><span class='label label{$STATUSS[$status]}'>{{$status}}</span></td>";
		$html[]="<td style='width:1%' nowrap><span class='label label{$prioritys[$priority]}'>$priority</span>&nbsp;&nbsp;<span class='label label{$severitys[$severity]}'>$severity</td>";
		$html[]="<td style='width:1%' nowrap>".$tpl->td_href($component,"{view}",$view)."</td>";
		$html[]="<td><strong>v{$version}:<br>".$tpl->td_href($summary,"{view}",$view)."</td>";
		$html[]="<td style='width:1%' nowrap>".$tpl->td_href($creation_time,"{view}",$view)."</td>";
		$html[]="<td style='width:1%' nowrap>".$tpl->td_href($last_change_time,"{view}",$view)."</td>";
