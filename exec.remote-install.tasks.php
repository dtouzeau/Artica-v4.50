...
if(!Build_pid_func(__FILE__,"MAIN")){writelogs(basename(__FILE__).":Already executed.. aborting the process",basename(__FILE__),__FILE__,__LINE__);exit();}
...
function ScanComputers_deploy(){
	...
	$hash=unserialize(base64_decode($GLOBALS["CLASS_SOCKETS"]->GET_INFO("GlobalNetAdmin")));
