...
$GLOBALS["PROGRESS_FILE"]="/usr/share/artica-postfix/ressources/logs/squid.import.progress";
$GLOBALS["LOG_FILE"]=PROGRESS_DIR."/squid.import.progress.txt";
...
function js(){
	...
	$title=$tpl->javascript_parse_text("{compressed_file}}");
	echo "
	YahooWinBrowseHide();		
...
function popup(){
	...
	$sock->getFrameWork("squid.php?import-squid-zip=yes&filename=".urlencode($_GET["filename"])."");
	$t=$_GET["t"];
