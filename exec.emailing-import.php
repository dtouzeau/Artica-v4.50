...
if($argv[1]=="--id"){parse_db($argv[2]);exit();}
if($argv[1]=="--import-id"){import_users($argv[2]);exit();}
if($argv[1]=="--make-unique"){make_database_unique($argv[2]);exit();}
if($argv[1]=="--get-prefix"){get_prefix($argv[2]);exit();}
