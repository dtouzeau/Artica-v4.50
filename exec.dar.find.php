...
if(posix_getuid()<>0){events("Cannot be used in web server mode");exit();}
...
if($argv[1]==null){events("No id specified");exit();}
if($argv[1]=='--restore'){restore($argv[2],$argv[3],$argv[4]);exit();}
