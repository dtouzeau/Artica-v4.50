...
session_start();
	...
	if(!$usersprivs->AllowAddUsers){$tpl=new templates();echo $tpl->_ENGINE_parse_body("alert('{ERROR_NO_PRIVS}')");die("DIE " .__FILE__." Line: ".__LINE__);}	
...
function homebind_page(){
	...
	<tr>
		...
		<td><input type='button' OnClick=\"Loadjs('SambaBrowse.php?field=homeDirectoryBinded&no-shares=yes');\" value='{browse}...'>
