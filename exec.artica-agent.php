...
if(isset($_GET["noop"])){receive_noop_connection();exit();}
if(isset($_GET["setdrive"])){receive_directories_list();exit();}
if(isset($_GET["start-backup-rsync"])){receive_rsync_start();exit();}
if(isset($_GET["write-error"])){receive_rsync_error();exit();}
if(isset($_GET["rsync-finish"])){receive_rsync_finish();exit();}
if(isset($_GET["order-executed-id"])){receive_order_executed();exit();}
if(isset($_GET["wmi-infos"])){receive_wmi();exit();}
