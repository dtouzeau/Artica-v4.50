...
$GLOBALS["CACHEFILE"]=PROGRESS_DIR."/php-snmp.progress";
$GLOBALS["LOGSFILES"]=PROGRESS_DIR."/php-snmp.progress.txt";
...
function title(){
	...
	$title=$tpl->_ENGINE_parse_body("{checking_php_snmp}");
...
function Launch(){
	$sock=new sockets();
	$cmd="system.php?php-snmp-progress=yes";
