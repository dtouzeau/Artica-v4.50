...
$GLOBALS["CACHEFILE"]=PROGRESS_DIR."/download_progress";
$GLOBALS["LOGSFILES"]=PROGRESS_DIR."/download_progress_text";
...
function js(){
	...
	$t=time();
	$title=$tpl->javascript_parse_text("{update_artica_software}");
...
function popup(){
	...
	$text=$tpl->_ENGINE_parse_body("{update_artica_software}...");
