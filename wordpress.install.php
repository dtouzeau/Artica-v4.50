...
$GLOBALS["LOG_FILE"]=PROGRESS_DIR."/wordpress.reconfigure.progress.txt";
...
function js(){
	...
	$title=$tpl->javascript_parse_text("{install_wordpress}");
	echo "
	YahooWinBrowseHide();		
...
function popup(){
	...
	$sock->getFrameWork("wordpress.php?install=yes");
	$t=$_GET["t"];
