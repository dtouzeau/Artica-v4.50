...
function backend_popup(){
    ...
    if(!is_numeric($hap->MainConfig["slowstart"])){$hap->MainConfig["slowstart"]=0;}
    ...
    $form[]=$tpl->field_numeric("slowstart","{slow} {start}", $hap->MainConfig["slowstart"]);
...
function backends_save(){
    ...
    $hap->MainConfig["slowstart"]=$_POST["slowstart"];
