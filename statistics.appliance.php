...
function popup(){
	...
	Paragraphe_switch_img("{webproxy_statistics_appliance}","{webproxy_statistics_appliance_text}",
	"EnableWebProxyStatsAppliance",$EnableWebProxyStatsAppliance,null,380)."
	<hr>
