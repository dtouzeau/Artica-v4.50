...
function js(){
	...
	$tpl=new template_admin();
	$tpl->js_dialog6("{system}::libmilter1.0.1", "$page?popup=yes",650);
}
...
function popup(){
	...
	$ARRAY["CMD"]="services.php?apt-get-install=libmilter1.0.1";
	$ARRAY["TITLE"]="{system} {installing} libmilter1.0.1";
