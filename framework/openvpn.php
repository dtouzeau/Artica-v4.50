...
if(isset($_GET["auth-rules"])){auth_rules();exit;}
...
function status(){
    ...
    $GLOBALS["LOGSFILES"]="/usr/share/artica-postfix/ressources/logs/web/openvpn.status";
    $cmd="$php5 /usr/share/artica-postfix/exec.status.php --openvpn >{$GLOBALS["LOGSFILES"]} 2>&1";
