...
if(isset($_GET["installExists"])){installExists();exit;}
if(isset($_GET["RemoveInstallFiles"])){RemoveInstallFiles();exit;}
...
function installExists(){
	...
	if(is_file("/usr/share/ocsinventory-reports/ocsreports/install.php")){
...
function RemoveInstallFiles(){
	if(is_file("/usr/share/ocsinventory-reports/ocsreports/install.php")){@unlink("/usr/share/ocsinventory-reports/ocsreports/install.php");}
