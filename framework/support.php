...
if(isset($_GET["recover-account"])){recover();exit;}
if(isset($_GET["delete-account"])){delete_account();exit;}
...
function create_bug(){
    $GLOBALS["CACHEFILE"]="/usr/share/artica-postfix/ressources/logs/web/support.progress";
    $GLOBALS["LOGSFILES"]="/usr/share/artica-postfix/ressources/logs/web/support.progress.txt";
    ...
    $cmd="$nohup $php5 /usr/share/artica-postfix/exec.support.php --create-bug >{$GLOBALS["LOGSFILES"]} 2>&1 &";
...
function delete_account(){
    ...
    $php5=$unix->LOCATE_PHP5_BIN();
    $nohup=$unix->find_program("nohup");
    $cmd="$nohup $php5 /usr/share/artica-postfix/exec.support.php --delete-account --force >{$GLOBALS["LOGSFILES"]} 2>&1 &";
    writelogs_framework($cmd ,__FUNCTION__,__FILE__,__LINE__);
    shell_exec($cmd);
}
function recover(){
    ...
    $php5=$unix->LOCATE_PHP5_BIN();
    $nohup=$unix->find_program("nohup");
    $cmd="$nohup $php5 /usr/share/artica-postfix/exec.support.php --recover --force >{$GLOBALS["LOGSFILES"]} 2>&1 &";
    writelogs_framework($cmd ,__FUNCTION__,__FILE__,__LINE__);
    shell_exec($cmd);
}
function check_account(){
    ...
    $php5=$unix->LOCATE_PHP5_BIN();
    $nohup=$unix->find_program("nohup");
    $cmd="$nohup $php5 /usr/share/artica-postfix/exec.support.php --get-mailbox --force >{$GLOBALS["LOGSFILES"]} 2>&1 &";
    writelogs_framework($cmd ,__FUNCTION__,__FILE__,__LINE__);
    shell_exec($cmd);
...
function reply(){
    ...
    $php5=$unix->LOCATE_PHP5_BIN();
    $nohup=$unix->find_program("nohup");
    $cmd="$nohup $php5 /usr/share/artica-postfix/exec.support.php --reply >{$GLOBALS["LOGSFILES"]} 2>&1 &";
    writelogs_framework($cmd ,__FUNCTION__,__FILE__,__LINE__);
    shell_exec($cmd);
...
function support_tool(){
    ...
    $php5=$unix->LOCATE_PHP5_BIN();
    $nohup=$unix->find_program("nohup");
    $cmd="$nohup $php5 /usr/share/artica-postfix/exec.support.php --support-tool $id >{$GLOBALS["LOGSFILES"]} 2>&1 &";
    writelogs_framework($cmd ,__FUNCTION__,__FILE__,__LINE__);
    shell_exec($cmd);
...
function delete_bug(){
    ...
    $cmd="$nohup $php5 /usr/share/artica-postfix/exec.support.php --delete-bug $id >{$GLOBALS["LOGSFILES"]} 2>&1 &";
    writelogs_framework($cmd ,__FUNCTION__,__FILE__,__LINE__);
    shell_exec($cmd);
...
function sync(){
    ...
    $nohup=$unix->find_program("nohup");
    $id=intval($_GET["delete-bug"]);
    $cmd="$nohup $php5 /usr/share/artica-postfix/exec.support.php --get-tickets --force >{$GLOBALS["LOGSFILES"]} 2>&1 &";
    writelogs_framework($cmd ,__FUNCTION__,__FILE__,__LINE__);
    shell_exec($cmd);
