...
function install():bool{
    $unix=new unix();
    return $unix->framework_execute("exec.cgroups.php --install","cgroups.install.progress","cgroups.install.progress.txt");
}
function uninstall():bool{
    $unix=new unix();
    return $unix->framework_execute("exec.cgroups.php --uninstall","cgroups.install.progress","cgroups.install.progress.txt");
}
